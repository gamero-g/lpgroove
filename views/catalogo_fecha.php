...
$fechaDeLanzamiento = $_GET['anio_de_lanzamiento'];

$discos = Disco::filtrarPorFechas($fechaDeLanzamiento);
...
<section class="container">
    <div class="d-flex flex-column flex-lg-row" id="catalogoCompletoConFiltros">
        <div>
            <span class="bg-white p-1 rounded-2 text-black"><?= $fechaDeLanzamiento ?> <a href="index.php?seccion=catalogo" class="text-black">X</a></span>
            <h2 class="text-center border-bottom fs-3">Filtros</h2>
            <div>
        ...
        <div>
            ...
            <?php 
            if($discos) { ?> 
                <h2 class="text-center py-5 text-personalizado  bg-black">  Discos de <span class="text-light"><?= $fechaDeLanzamiento ?></span></h2>
                ...
                <?php foreach ($discos as $disco) { ?>
                    ...
                    <section class="p-4">
                        ...
                        <a href="index.php?seccion=detalle_producto&id=<?= $disco->getId() ?>" class="d-block text-decoration-none bg-transparent">
            ...
            <?php } else { ?>
                <h2 class="text-center py-5">Lo sentimos, no contamos con discos de esas fechas!</h2>
            <?php }  ?>
        </div>
    </div>
</section>
